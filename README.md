...
## 一款无痕无感的 AI 工具，让你可以在「受控设备/受限环境」使用 AI, 极速且高效且稳定
...
3. 打开「音频 MIDI 设置」-> 创建「多输出设备」，勾选内建输出 + BlackHole 2ch -> 右键将「多输出设备」设为系统默认输出
```
...
3. 按钮说明: 
  ...
  3.2 语音分析按钮, 点击会提交当前语音转写文本「作为问题」, 提交给 AI 获取回答, 注意: 提交缓存的所有的语音转写文本
